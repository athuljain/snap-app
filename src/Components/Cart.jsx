  ...
  return (
    <div className="main-div">
      <div className="item-box">
        <button className="head-button" id="head">
          Total Cart Items
        </button>
        <br />
        <br />
        <label>Enter ID</label> <br />{" "}
        <input onChange={inputId} className="inputId" type="number" />
        <br />
        <label>Enter Name</label> <br />{" "}
        <input onChange={inputName} className="inputName" type="text" />
        <br />
        <label>Enter Price</label> <br />{" "}
        <input onChange={inputPrice} className="inputPrice" type="number" />
        <br />
